exports.create = (req,res)=>{
    ...
    // new application
    const property = new applicationdb({
        user_ID : req.body.user_ID,
        renterScore : req.body.renterScore,
        looking_in: req.body.looking_in,
        rent_type: req.body.rent_type,
        submitted_enquiries: req.body.submitted_enquiries,
        approved_enquiries: req.body.approved_enquiries,
        Identification : req.body.Identification ,
        Background_check: req.body.Background_check,
        numPets_: req.body.numPets_,
        income_ : req.body.income_,
        bondhistory_: req.body.bondhistory_,
        education_: req.body.education_,
        Occupation_: req.body.Occupation_,
        References_: req.body.References_,
        Credit_score: req.body.Credit_score,
        testimonials_: req.body.testimonials_,
    })
